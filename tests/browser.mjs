...
try{
 ...
 await page.locator('input[name=lyrics]').setInputFiles({name:'lyrics.lrc',mimeType:'text/plain',buffer:Buffer.from('[00:00]let the words\n[00:00.8]come to life')});
 ...
 console.log('PASS: project subpath, logo, browser MP4 with audio, download, mobile layout');
